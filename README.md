...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-avatar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15133&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-avatar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-avatar` can be installed with:

```
conda install django-avatar
```

It is possible to list all of the versions of `django-avatar` available on your platform with:
